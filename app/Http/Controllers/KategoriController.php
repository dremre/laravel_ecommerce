...
class KategoriController extends  Controller{
    public function  index($slug_kategoriad){

        $kategori =Kategori::where('slug',$slug_kategoriad)->firstOrFail();
        ...
        if($order == 'coksatanlar'){
            ...
            $urunler = $kategori->urunler()->orderByDesc('olusturma_tarihi')->paginate(2);
