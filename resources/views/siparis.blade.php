...
@section('content')
    ...
    <div class="container">
        <div class="bg-content">
            <a href="{{route('siparisler')}}" class="btn btn-xs btn-danger">
                <i class="glyphicon glyphicon-arrow-left"> Siparişlere Dön</i></a>
            ...
            <table class="table table-bordererd table-hover">
                ...
                <tr>
                    ...
                    <td style="color: darkred" colspan="2">{{$siparis->siparis_tutari}} ₺</td>
                </tr>
                <tr>

                    <th colspan="4" class="text-right">Toplam Tutar(KDV Dahil)</th>
                    <td style="color: darkred" colspan="2">{{$siparis->siparis_tutari * (118/100) }} ₺</td>
                </tr>

                <tr>

                    <th colspan="4" class="text-right">Sipariş Durumu</th>
                    <td style="color: darkred" colspan="2">{{$siparis->durum}}</td>
                </tr>
