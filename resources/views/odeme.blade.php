                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="adres" id="adres" value="{{auth()->user()->detay->adres}}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control telefon" name="telefon" id="telefon" value="{{auth()->user()->detay->telefon}}">
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="ceptelefonu">Cep Telefonu</label>
                                <input type="text" class="form-control telefon" name="ceptelefonu" id="ceptelefonu" value="{{auth()->user()->detay->ceptelefon}}" required>
                            </div>
                        </div>
                    </div>
                </div>
